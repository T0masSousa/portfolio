                ...
                <div className="row pb-5 mb-5">  
                    <div className="col-md-6 mt-auto mb-auto">
                        ...
                        <div className='pt-2'>
                            ...
                            <p className='fs-5 text-white'>Feel free to contact me if you'd like to chat more.</p>
                            <p className='fs-5 text-white'>I'm looking forward to <n className='coloredText'>working with you</n>!</p>
                            <p className='fs-5 text-white coloredText'>"If you do what you love, you'll never work a day in your life." - <n style={{fontStyle:'italic', opacity:'75%'}}>Marc Anthony</n></p>
                        </div>
                    </div>
                </div>
